!function (t, e) {
  ...
  function at(t, e, n, r) {
    var o = K(e), i = function (t, e, n, r) {
      var o = B(e), i = r[r.length - 1], a = new Array(i).fill(0), s = e.length, u = "complex64" === n ? ct(t) : t;
  ...
  var Mt, Ot, Pt = Object.freeze({
    ...
    return t.prototype.moveData = function (t) {
      ...
      var o = {
        id: this.nextTapeNodeId++, name: this.activeScope.name, inputs: n, outputs: [e], gradient: function (t) {
          var n = {};
  ...
  function Te(t, e, n) {
    ...
    var s = r < 1 ? 1 : r;
    return {sliceRank: r, numUpdates: e.size / s, sliceSize: i, strides: K(n.slice(0, r)).concat([1]), outputSize: B(n)}
  }
  ...
  function fn(t, e, n, r, o) {
    for (var i = e[e.length - 1], a = [t.length / i, i], s = a[0], u = a[1], c = A(n, s * r), l = A("int32", s * r), h = 0; h < s; h++) {
      for (var p = h * u, f = t.subarray(p, p + u), d = [], v = 0; v < f.length; v++) d.push({value: f[v], index: v});
      d.sort(function (t, e) {
        ...
        return function (t, e, n) {
          ...
          return o.length <= i.length && (r += n ? function (t, e) {
            var n, r = t.name, o = r.charAt(0).toUpperCase() + r.slice(1), i = "get" + o + "AtOutCoords",
              ...
              u = gn(t.shapeInfo.logicalShape, e.logicalShape), c = Dn(s), l = s - a, h = ["x", "y", "z", "w", "u", "v"];
            ...
            var n = t.name, r = n.charAt(0).toUpperCase() + n.slice(1), o = "get" + r + "AtOutCoords", i = e.texShape,
              a = t.shapeInfo.texShape, s = t.shapeInfo.logicalShape.length, u = e.logicalShape.length;
  ...
  function _n(t) {
    ...
    switch (e.length) {
      ...
      case 4:
        return function (t) {
          var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = e[3],
            i = e[2] * o, a = e[1] * i, s = I(e), u = s.newShape, c = s.keptDims;
      ...
      case 5:
        return function (t) {
          var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = e[4],
            i = e[3] * o, a = e[2] * i, s = e[1] * a, u = I(e), c = u.newShape, l = u.keptDims;
      ...
      case 6:
        return function (t) {
          var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = I(e),
            i = o.newShape, a = o.keptDims;
  ...
  var Pn = function (t, e, n, r) {
    ...
    jn = function (t, e, n) {
      ...
      this.variableNames = ["x", "dy"], this.outputShape = t.filterShape;
      var e = t.strideHeight, n = t.strideWidth, r = t.padInfo.top, o = t.padInfo.left, i = t.outChannels / t.inChannels;
  ...
  var va = function () {
    ...
    return t.prototype.register = function (t, e, n) {
      ...
      if (!this.pendingDisposal.has(t)) if (this.pendingRead.has(t)) this.pendingDisposal.add(t); else if (this.texData.has(t)) {
        var e = this.texData.get(t), n = e.texture, r = e.dtype, o = e.texShape, i = e.usage, a = e.complexTensors,
          s = e.isPacked, u = e.slice;
        if (null != n) {
      ...
      var h = kt(t.dtype, e.dtype), p = new Wo(t.shape, [s, o, i], n, r), f = this.makePackedTensor(p.outputShape, h);
      return this.compileAndRun(p, [t, e], f)
    }, t.prototype.fusedBatchMatMul = function (t, e, n, r, o, i) {
      var a = n ? t.shape[2] : t.shape[1], s = r ? e.shape[1] : e.shape[2], u = t.shape[0], c = kt(t.dtype, e.dtype),
      ...
      var i = ke(o), a = new dn({windowSize: i, inSize: o, batchSize: r}, e, null == n), s = a.outputShape, u = s[0],
        c = s[1], l = this.makeOutputArray([u, c], "int32"), h = [t];
      ...
      var i = t.shape[0], a = t.shape[1], s = function (t, e) {
          ...
          return n
        }(a, o), u = new ni({windowSize: s, inSize: a, batchSize: i, numSegments: o}, e), c = u.outputShape, l = c[0],
        h = c[1], p = this.makeOutputArray([l, h], r);
      ...
      var e = new mi(t.shape, "return float(!isnan(x) && !isinf(x));"), n = this.makeOutputArray(e.outputShape, "bool");
      return this.compileAndRun(e, [t], n)
    }, t.prototype.round = function (t) {
      ...
      var r = t.shape, o = this.texData.get(t.dataId), i = n.inChannels, a = r[0] * r[1] * r[2], s = n.outChannels,
        u = (1 === a || 1 === s) && 1e3 < i, c = r[2] % 2 != 0 && !!o.isPacked;
      ...
      var p = dt.make([1, r[0] * r[1] * (r[2] + 1), n.inChannels], {dataId: t.dataId}, t.dtype, this), f = o.shape;
      ...
      var r = n.filterWidth, o = n.filterHeight, i = n.inChannels, a = n.outWidth, s = n.outHeight, u = r * o * i,
        ...
        d = this.compileAndRun(f, [h]).reshape([1, l[0], l[1]]), v = new Wo(d.shape, [1, c, n.outChannels], !0, !1);
      ...
      var n = this.texData.get(t.dataId), r = new mr(dr, t.shape, e), o = new mr(vr, t.shape, e),
        ...
        a = this.compileAndRun(r, i), s = this.compileAndRun(o, i), u = this.complex(a, s).as2D(t.shape[0], t.shape[1]);
      return a.dispose(), s.dispose(), u
    },t.prototype.gatherND = function (t, e) {
      var n = e.shape, r = n[n.length - 1], o = Ne(t, e), i = o[0], a = o[1], s = o[2], u = o[3], c = e.reshape([a, r]),
        l = t.reshape([t.size / s, s]), h = new _r(r, u, [a, s]);
  ...
  }), us = Fe({batchNorm_: es}), cs = Fe({batchNorm2d_: Ja}), ls = Fe({batchNorm3d_: Za}), hs = Fe({batchNorm4d_: ts});
      ...
      _ = E[1], S = E[2], R = function (t, e, n, r, o, i, a, s, u, c) {
        ...
        if ("same" === t) {
          var d = ((h = Math.ceil(e / o)) - 1) * o + s - e, v = ((p = Math.ceil(n / i)) - 1) * i + u - n,
            m = ((f = Math.ceil(r / a)) - 1) * a + c - r, g = Math.floor(d / 2), y = d - g, x = Math.floor(v / 2),
            w = v - x, b = Math.floor(m / 2);
  ...
  var ju = Fe({
    ...
    selu_: function (t) {
      ...
      return Zt.engine.runKernel(function (t, e) {
        ...
        return {
          $x: function () {
            var t = a.greater(Ve(0)), e = Ve(di), n = Ve(vi), r = i.mul(n), o = i.mul(e).mul(a.toFloat().exp());
            return Hu(t, r, o)
          }
        }
      })
        ...
        return {
          $x: function () {
            var t = y.shape, e = m.size, n = t.slice(0, g), r = n.length, o = t.slice(g, t.length).slice(1),
              ...
              l = m.reshape([e]), h = ec([[r], a, s]), p = c.transpose(h), f = rc(p, l, y.shape[g]), d = _e(h);
  ...
  var oc = Fe({
    basicLSTMCell_: function (t, e, n, r, o, i) {
      var a = re(t, "forgetBias", "basicLSTMCell"), s = re(e, "lstmKernel", "basicLSTMCell"),
        u = re(n, "lstmBias", "basicLSTMCell"), c = re(r, "data", "basicLSTMCell"), l = re(o, "c", "basicLSTMCell"),
        h = re(i, "h", "basicLSTMCell"), p = c.concat(h, 1).matMul(s).add(u), f = p.shape[0], d = p.shape[1] / 4,
        v = [f, d], m = p.slice([0, 0], v), g = p.slice([0, d], v), y = p.slice([0, 2 * d], v),
        x = p.slice([0, 3 * d], v), w = m.sigmoid().mulStrict(g.tanh()).addStrict(l.mulStrict(a.add(y).sigmoid()));
  ...
  var sc = Fe({
    stridedSlice_: function (t, e, n, r, o, i, a, s, u) {
      ...
      if (r.every(function (t) {
        ...
        var l = Ae(c.shape, e, n, r, o, i, a, s, u), h = l[0], p = l[1], f = l[2], d = p.filter(function (t, e) {
  ...
  var lc = Fe({
    ...
    irfft_: function (t) {
      ...
      var i = [n, 2 * (e - 1)], a = ze(t).as2D(n, e), s = Ue(t).as2D(n, e), u = a.slice([0, 1], [n, e - 2]).reverse(1),
        c = s.slice([0, 1], [n, e - 2]).reverse(1).mul(Ve(-1)), l = a.concat(u, 1), h = s.concat(c, 1);
  ...
  var xc = Fe({
    ...
    sigmoidCrossEntropy_: function (t, e, n, r, o) {
      ...
      var i = re(t, "multiClassLabels", "sigmoidCrossEntropy"), a = re(e, "logits", "sigmoidCrossEntropy"), s = null;
      ...
      var h = function (t, e) {
        var n = re(t, "labels", "sigmoidCrossEntropyWithLogits"), r = re(e, "logits", "sigmoidCrossEntropyWithLogits");
  ...
  var Oc = Fe({
    ...
    nonMaxSuppression_: function (t, e, n, r, o) {
      ...
      var i = re(t, "boxes", "nonMaxSuppression"), a = re(e, "scores", "nonMaxSuppression"), s = Mc(i, a, n, r, o);
  ...
  var Vc = function () {
    ...
    return t.prototype.setDataMover = function (t) {
      ...
      var t = xn(s.shape, u.shape), l = zi(t, "float32"), e = zi(t, "float32"), h = s.dataSync(), p = u.dataSync(),
        f = gn(s.shape, t), d = gn(u.shape, t), v = l.values, m = e.values;
        ...
        if (!(s <= R)) for (var N = 1 < p ? (_ - E) * (u - 1) / (p - 1) : 0, k = 1 < f ? (S - C) * (c - 1) / (f - 1) : 0, I = 0; I < p; I++) {
          ...
          if (T < 0 || u - 1 < T) for (var A = 0; A < f; A++) for (var D = 0; D < l; D++) {
            ...
            for (A = 0; A < f; A++) if ((q = 1 < f ? C * (c - 1) + A * k : .5 * (C + S) * (c - 1)) < 0 || c - 1 < q) for (D = 0; D < l; D++) M = D + A * x[2] + I * x[1] + w * x[0], d.values[M] = i; else {
              ...
              for (D = 0; D < l; D++) {
                var z = g[M = D + L * y[2] + O * y[1] + R * y[0]], U = g[M = D + B * y[2] + O * y[1] + R * y[0]],
        ...
        return R(this, function (t) {
          return u = (e = u).startsWith(ul.URL_SCHEME) ? e.slice(ul.URL_SCHEME.length) : e, [2, new Promise(function (a, s) {
            ...
            e.onupgradeneeded = function () {
              ...
              var n, r = e.result, t = r.transaction(il, "readwrite"), o = t.objectStore(il), i = o.get(u);
  ...
  var hl = "/", pl = "tensorflowjs_models", fl = "info", dl = "model_topology", vl = "weight_specs", ml = "weight_data",
    gl = "model_metadata";
                  ...
                  n.forEach(function (t) {
                    ...
                    t.paths.forEach(function (r) {
                      ...
                      t.onload = function (t) {
                        ...
                        u[n] = e, -1 === u.indexOf(null) && c({modelTopology: o, weightSpecs: a, weightData: Xc(u)})
                      }, t.onerror = function (t) {
            ...
            case 0:
              if (a = f.map(function () {
                ...
                t.weights.forEach(function (n) {
                  var t = "quantization" in n ? n.quantization.dtype : n.dtype, e = qc[t] * B(n.shape),
                    r = function () {
  ...
  }), $l = Object.freeze({gpgpu_util: Do, webgl_util: co, MathBackendWebGL: va, GPGPUContext: Mo}), Kl = function (t) {
    function e() {
  ...
  var eh = function (a) {
    ...
    return s(t, a), t.prototype.applyGradients = function (t) {
      var h = this, e = function (i) {
        ...
        var s = n.accumulatedMeanSquares[i], u = n.accumulatedMeanGrads[i], c = n.accumulatedMoments[i], l = t[i];
        ue(function () {
  ...
  var _h, Sh = function () {
    function l(t, e) {
      void 0 === e && (e = !0);
      var n = t || {}, r = [n.left, n.top, n.right, n.bottom].every(Eh), o = [n.x, n.y, n.width, n.height].every(Eh);
    ...
    return l.isRect = function (t) {
      ...
      return n < r && (t -= o / 2, n += o), r < n && (e -= o / 2, r += o), new l({x: t, y: e, width: n, height: r})
  ...
  var Vh = function (t) {
    void 0 === t && (t = {});
    var e = t.anchorPosition, n = t.backgroundColor, r = t.fontColor, o = t.fontSize, i = t.fontStyle, a = t.padding;
    ...
    return t.prototype.draw = function (t) {
      var e = Gh(t), n = this.options, r = n.boxColor, o = n.lineWidth, i = this.box, a = i.x, s = i.y, u = i.width,
        c = i.height;
  ...
  function fp(t, e, n) {
    ...
    var a = sp(t), s = e / Math.max(a.height, a.width), u = s * a.width, c = s * a.height,
      l = up({width: e, height: e}), h = t instanceof i ? t : cp(t), p = Math.abs(u - c) / 2, f = n && u < c ? p : 0,
      d = n && c < u ? p : 0;
  ...
  function Ep(s, u) {
    return ue(function () {
      var t = u[0], e = u[1], n = u[2], r = Je(s.shape.slice(0, 3).concat([1]), t),
        o = Je(s.shape.slice(0, 3).concat([1]), e), i = Je(s.shape.slice(0, 3).concat([1]), n), a = _i([r, o, i], 3);
      return Bu(s, a)
    })
  }
  ...
  function Gp(o, i, a, s) {
    return void 0 === a && (a = !1), void 0 === s && (s = !0), ue(function () {
      var t = Xu(a ? xu(Ss(o, i.conv0.filters, s ? [2, 2] : [1, 1], "same"), i.conv0.bias) : zp(o, i.conv0, s ? [2, 2] : [1, 1])),
        e = zp(t, i.conv1, [1, 1]), n = zp(Xu(xu(t, e)), i.conv2, [1, 1]), r = zp(Xu(xu(t, xu(e, n))), i.conv3, [1, 1]);
  ...
  var jp = function (t) {
    ...
    return a(e, t), e.prototype.forwardInput = function (e) {
      ...
      return function (t) {
        var e = [], n = np(t), r = n.extractWeights, o = n.getRemainingWeights, i = Vp(r, e).extractDenseBlock4Params,
          a = i(3, 32, "dense0", !0), s = i(32, 64, "dense1"), u = i(64, 128, "dense2"), c = i(128, 256, "dense3");
  ...
  function of(t, e) {
    var n = t.detection.box, r = e.shiftBy(n.x, n.y), o = r.align(), i = t.detection.imageDims,
      a = {landmarks: r, unshiftedLandmarks: e, alignedRect: new Lp(t.detection.score, o.rescale(i.reverse()), i)};
  ...
  var vf = function (n) {
    ...
    return a(t, n), Object.defineProperty(t.prototype, "faceFeatureExtractor", {
      ...
      return function (t) {
        var e = [], n = np(t), r = n.extractWeights, o = n.getRemainingWeights, i = Qh(r, e), a = i(512, 1, "fc/age"),
          s = i(512, 2, "fc/gender");
        if (0 !== o().length) throw new Error("weights remaing after extract: " + o().length);
  ...
  var Cf = function (t) {
    ...
    return a(e, t), e.prototype.forwardInput = function (e) {
      ...
      return function (t) {
        var e = [], n = np(t), r = n.extractWeights, o = n.getRemainingWeights, i = Vp(r, e).extractDenseBlock3Params,
          a = i(3, 32, "dense0", !0), s = i(32, 64, "dense1"), u = i(64, 128, "dense2");
        if (0 !== o().length) throw new Error("weights remaing after extract: " + o().length);
  ...
  var Mf = function (t) {
    ...
    return a(e, t), e.prototype.forwardInput = function (n) {
      ...
      return function (t) {
        var e = [], n = Tf(t, e), r = n.extractConvLayerParams, o = n.extractResidualLayerParams, i = r("conv32_down"),
          a = o("conv32_1"), s = o("conv32_2"), u = o("conv32_3"), c = o("conv64_down"), l = o("conv64_1"),
          h = o("conv64_2"), p = o("conv64_3"), f = o("conv128_down"), d = o("conv128_1"), v = o("conv128_2"),
          m = o("conv256_down"), g = o("conv256_1"), y = o("conv256_2"), x = o("conv256_down_out"), w = t.fc;
        if (e.push({
          originalPath: "fc",
          paramPath: "fc"
      ...
      return function (t) {
        var e = np(t), n = e.extractWeights, r = e.getRemainingWeights, o = [], i = If(n, o),
          ...
          p = s(36864, 64, 3, "conv64_down", !0), f = s(36864, 64, 3, "conv64_1"), d = s(36864, 64, 3, "conv64_2"),
          v = s(36864, 64, 3, "conv64_3"), m = s(147456, 128, 3, "conv128_down", !0),
          g = s(147456, 128, 3, "conv128_1"), y = s(147456, 128, 3, "conv128_2"),
          x = s(589824, 256, 3, "conv256_down", !0), w = s(589824, 256, 3, "conv256_1"),
          b = s(589824, 256, 3, "conv256_2"), E = s(589824, 256, 3, "conv256_down_out"), C = ue(function () {
  ...
  function Lf(t) {
    var e = [], n = function (t, e) {
      ...
      function n(t) {
        var e = "mobilenetv1/conv_" + t, n = "MobilenetV1/Conv2d_" + t + "_depthwise", r = e + "/depthwise_conv",
          o = e + "/pointwise_conv";
        return {
          depthwise_conv: {
      ...
      return ue(function () {
        var l, h, p, o, i, a, t = u.toBatchTensor(512, !1).toFloat(),
          ...
          n = (l = e.out, h = e.conv11, p = c.prediction_layer, ue(function () {
            var t = Bf(Bf(l, p.conv_0, [1, 1]), p.conv_1, [2, 2]), e = Bf(Bf(t, p.conv_2, [1, 1]), p.conv_3, [2, 2]),
              n = Bf(Bf(e, p.conv_4, [1, 1]), p.conv_5, [2, 2]), r = Bf(Bf(n, p.conv_6, [1, 1]), p.conv_7, [2, 2]),
              o = Vf(h, p.box_predictor_0), i = Vf(l, p.box_predictor_1), a = Vf(t, p.box_predictor_2),
              s = Vf(e, p.box_predictor_3), u = Vf(n, p.box_predictor_4), c = Vf(r, p.box_predictor_5);
            return {
            ...
            case 2:
              return w = E.apply(b, [t.sent()]), e = w, n = h, i = .5, a = p, r = (o = g).shape[0], s = Math.min(n, r), u = e.map(function (t, e) {
                ...
                var e = [Math.max(0, k[t][0]), Math.min(1, k[t][2])].map(function (t) {
                  return t * N
                }), n = e[0], r = e[1], o = [Math.max(0, k[t][1]), Math.min(1, k[t][3])].map(function (t) {
                  return t * R
                }), i = o[0], a = o[1];
    ...
    var e = np(t), n = e.extractWeights, r = e.getRemainingWeights, o = [], i = function (r, o) {
      ...
      return {
        extractPNetParams: function () {
          var t = h([3, 10, 16, 32], "pnet"), e = u(32, 2, 1, "pnet/conv4_1"), n = u(32, 4, 1, "pnet/conv4_2");
          return O({}, t, {conv4_1: e, conv4_2: n})
        }, extractRNetParams: function () {
          var t = h([3, 28, 48, 64], "rnet", !0), e = c(576, 128, "rnet/fc1"), n = l(128, "rnet/prelu4_alpha"),
            r = c(128, 2, "rnet/fc2_1"), o = c(128, 4, "rnet/fc2_2");
          return O({}, t, {fc1: e, prelu4_alpha: n, fc2_1: r, fc2_2: o})
        }, extractONetParams: function () {
          var t = h([3, 32, 64, 64], "onet"), e = u(64, 128, 2, "onet/conv4"), n = l(128, "onet/prelu4_alpha"),
            r = c(1152, 256, "onet/fc1"), o = l(256, "onet/prelu5_alpha"), i = c(256, 2, "onet/fc2_1"),
            a = c(256, 4, "onet/fc2_2"), s = c(256, 10, "onet/fc2_3");
    ...
    var e = [], n = function (t, e) {
      ...
      return {
        extractPNetParams: function () {
          ...
          var t = h("rnet"), e = c("rnet/fc1"), n = l("rnet/prelu4_alpha"), r = c("rnet/fc2_1"), o = c("rnet/fc2_2");
          return O({}, t, {fc1: e, prelu4_alpha: n, fc2_1: r, fc2_2: o})
        }, extractONetParams: function () {
    ...
    var e = t.map(function (l) {
      ...
      var e = t.scoresTensor, n = t.regionsTensor, r = t.scale, o = t.statsForScale, i = function (t, o, i, e) {
        ...
        return n.map(function (t) {
          ...
          return {cell: e, score: n, region: new rd(r[t.y][t.x][0], r[t.y][t.x][1], r[t.y][t.x][2], r[t.y][t.x][3])}
        })
      }(e, n, r, u);
          ...
          case 1:
            return n = t.sent(), x.stage2_extractImagePatches = Date.now() - e, e = Date.now(), r = n.map(function (t) {
              var a, s, e = (a = t, s = y, ue(function () {
                var t = ad(a, s), e = id($p(ia(t, [t.shape[0], s.fc1.weights.shape[0]]), s.fc1), s.prelu4_alpha),
          ...
          case 1:
            return n = t.sent(), w.stage3_extractImagePatches = Date.now() - e, e = Date.now(), i = n.map(function (t) {
              var s, u, e = (s = t, u = x, ue(function () {
                ...
                var e = id($p(ia(t, [t.shape[0], u.fc1.weights.shape[0]]), u.fc1), u.prelu5_alpha), n = $p(e, u.fc2_1),
                  r = $i(eu(n, 1), 1), o = Le(Bu(n, r), 1), i = $p(e, u.fc2_2), a = $p(e, u.fc2_3);
